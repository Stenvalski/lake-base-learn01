-- Schema and reference data, as of the switch from Flyway to yoyo.
--
-- This is the starting point for every database. It is the Flyway B12
-- baseline without the app grants, which differ per environment and live in
-- 0002_app_grants.py. The Flyway history it replaces is in
-- archive/flyway-migrations/.
--
-- residency_requirement rows are FABRICATED sample data.
